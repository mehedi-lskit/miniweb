...
Route::group(['middleware' => ['verified', 'auth']],  function(){
    ...
    Route::get('/game', function () { return view('frontend.game'); });
    Route::get('/game-content', function () { return view('frontend.game-content'); });
    Route::get('/game-admin', function () { return view('frontend.game-admin'); });
